const FEATURES = [
  ...
  },
  {
    ...
    topicos: {
      ...
      fotos: {
        descricao: "",
        fotos: ["/fotos-features/imagemgeradordequestoes.png"],
      },
      conclusao:
  ...
  },
  {
    ...
    topicos: {
      links: {
        descricao: "",
        links: ["https://github.com/LucasSO-one/simpatia.git"],
      },
      introducao:
      ...
      fotos: {
        descricao: "",
        fotos: ["/fotos-features/imagemgeradordequestoesdescritivas.png"],
      },
      conclusao:
  ...
  },
  {
    ...
    equipe: ["Gabriel Lourenço de Oliveira"],
    topicos: {
      links: {
        descricao: "",
        links: ["https://github.com/Gabriel-Oliviera42/acessibilidade-web"],
      },
      introducao: `
  ...
  },
  {
    ...
    topicos: {
      links: {
        descricao: "",
        links: ["https://github.com/Tallesdev/SimpatiaPlanoAula.git"],
      },
      introducao: `
...
`,
      ...
      fotos: {
        descricao: "",
        fotos: ["/fotos-features/geradorplanodeaula.jpg"],
      },
      conclusao:
  ...
  },
  {
    ...
    data: "OUTUBRO DE 2025",
    descricao:
      "O módulo é composto por agentes de IA especializados em diversas áreas do conhecimento. Cada agente é orientado a conduzir o aluno no processo de construção do próprio entendimento, promovendo aprendizado ativo e evitando a simples entrega direta das respostas.",
    equipe: [
    ...
    topicos: {
      links: {
        descricao: "",
        links: ["https://github.com/AndersonCaproni/simpatia"],
      },
      introducao: `
...
O resultado entregue contempla um conjunto de agentes de IA especializados em diferentes áreas, operando em chats independentes. Cada agente conduz o aluno em um diálogo pedagógico estruturado, estimulando-o a refletir, explorar conceitos e construir sua própria linha de raciocínio. Dessa forma, o módulo oferece um ambiente interativo de perguntas e respostas no qual o estudante insere sua dúvida e recebe orientação progressiva até alcançar a solução.
      ...
      fotos: {
        descricao: "",
        fotos: ["/fotos-features/ajudaia1.png", "/fotos-features/ajudaia4.png"],
      },
      conclusao: `
  ...
  },
  {
    ...
    equipe: ["Talysson De Moura Da Silva"],
    topicos: {
      links: {
        descricao: "",
        links: ["https://github.com/Talysson19/Simpatico-IA---Oratoria.git"],
      },
      introducao: `
  ...
  },
  {
    ...
    data: "NOVEMBRO DE 2025",
    descricao:
      "O projeto é um gerador de plano de estudos inteligente para auxiliar o aluno na busca de um direcionamento e uma melhor organização do seu tempo.",
    equipe: [
      "Davi Costa Caetano",
    ...
    topicos: {
      links: {
        descricao: "",
        links: ["https://github.com/tifilial736/SimpatiaIA.git"],
      },
      introducao: `
...
Como resultado, o módulo entrega funcionalidades como criação orientada de planos de ensino, salvamento automático, edição estruturada de conteúdos, exportação em múltiplos formatos e navegação intuitiva, consolidando-se como uma solução eficaz para o apoio à gestão acadêmica.          `,
      fotos: {
        descricao: "",
        fotos: ["/fotos-features/planodeestudo.png"],
      },
      conclusao: `
Os resultados obtidos foram, agilidade e melhor direcionamento, no cronograma de estudos. Através deste projeto, obtivemos uma melhor percepção das divisões de um ciclo, na etapa de desenvolvimento, aplicação e teste. E possíveis melhorias, temos o desejo de ampliar a gama de matérias e metodologias de estudos, através de uma coleta de dados das respectivas áreas e melhorar a estrutura do site através da "área de feedbacks" que vamos implementar em breve.
  ...
  },
  {
    ...
    topicos: {
      links: {
        descricao: "",
        links: ["https://github.com/joaogabriel343/simpatico-atex.git"],
      },
      introducao: `
